...
namespace MiriyaEditor.GameProject
{
    ...
    class OpenProject
    {
        // path to save project data; AppData is avaliable for all app on windows
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\MiriyaEditor\";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Miriya\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Miriya\Screenshot.png");
        ...
        // remember where to create project and save data into file independent of location
        static OpenProject()
        {
            try
            {
